...
enum class AdTypePlacement(
    ...
    SEARCH("search", setOf(AdType.NATIVE, AdType.NONE), AdType.NATIVE),
    ...
    SCHEDULED("scheduled", setOf(AdType.BANNER, AdType.NONE), AdType.BANNER),
    ...
    EXIT("exit", setOf(AdType.BANNER, AdType.NONE), AdType.BANNER),
    NORMAL_INTERSTITIAL(
        "normalInterstitial",
